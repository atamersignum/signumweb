...
(function () {
    ...
    var Swiper = function (container, params) {
        ...
        var defaults = {
            ...
            bulletClass: 'paginglink',
            bulletActiveClass: 'paginglink-active',
            buttonDisabledClass: 'swiper-button-disabled',
            paginationHiddenClass: 'swiper-pagination-hidden',
			bulletActivateOnmouseOver:true,
            // Observer
            observer: false,
        ...
        s.initEvents = function (detach) {
            ...
            if (s.params.pagination && s.params.paginationClickable) {	
				...
				if(s.params.bulletActivateOnmouseOver)//Buraya ekleme yaptık
                	$(s.paginationContainer)[actionDom]('mouseover', '.' + s.params.bulletClass, s.onClickIndex);
				else
